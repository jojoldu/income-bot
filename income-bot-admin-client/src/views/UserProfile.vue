                    ...
                    <div class="card card-profile shadow">
                        <div class="row justify-content-center">
                            <div class="col-lg-3 order-lg-2">
                                <div class="card-profile-image">
                                    <a href="#">
                                        <img class="rounded-circle" src="img/theme/team-4-800x800.jpg">
                                    </a>
                                </div>
                            </div>
                        </div>
                        <div class="card-header text-center border-0 pt-8 pt-md-4 pb-0 pb-md-4">
                            <div class="d-flex justify-content-between">
                                <base-button class="mr-4" size="sm" type="info">Connect</base-button>
                                <base-button class="float-right" size="sm" type="default">Message</base-button>
                            </div>
                        </div>
                                    ...
                                    <div class="form-group">
                                        <base-input alternative=""
                                            ...
                                            <textarea class="form-control form-control-alternative"
                                                      placeholder="A few words about you ..." rows="4">A beautiful Dashboard for Bootstrap 4. It is Free and Open Source.</textarea>
                                        </base-input>
                                    </div>
                                </div>
                            </form>
