                        ...
                        <div class="card-body">
                            <div class="row icon-examples">
                                <div :key="icon.name + index"
                                     class="col-lg-3 col-md-6" v-for="(icon, index) in icons">
                                    <button :title="icon.name"
                                            class="btn-icon-clipboard"
                                            data-clipboard-text="air-baloon"
                                            type="button"
                                            v-b-tooltip.hover.top
                                            v-clipboard:copy="icon.name" v-clipboard:success="onCopy">
                                        <div>
                                            <i :class="icon.name"></i>
...
<script>
    ...
    import BTooltipDirective from 'bootstrap-vue/src/components/tooltip'
